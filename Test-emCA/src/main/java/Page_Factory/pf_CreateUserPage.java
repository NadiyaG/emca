...
public class pf_CreateUserPage extends pf_genericmethods {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='accordion']/li[7]/a") WebElement manageUsersandRoles;
	@FindBy(how = How.XPATH, using = "//*[@id='createAndManageLink']") WebElement MngUser;
	...
	@FindBy(xpath="//*[@id='token']") WebElement tconfigure;
	...
	@FindBy(how = How.XPATH, using = "//*[@id='authUser0']") WebElement authenticEmail;
	@FindBy(how = How.XPATH, using = "//*[@id='authPin0']") WebElement authenticTokenPw;
	@FindBy(how = How.XPATH, using = "//*[@id='authentication0']") WebElement authenticBtn;
	@FindBy(how = How.XPATH, using = "//*[@id='authSuccessID0']") WebElement tickMark;

	//@FindBy(how = How.ID, using = "createUserSignAndConfirm") WebElement createUserbtn;
	@FindBy(xpath="//*[@id='createUserSignAndConfirm']") WebElement createUserbtn;
	...
	public void createUser(String cName, String email2, String orgName, String telNo, String city2,
			String state2, String zip, String country2, String role2,String tconf, String tPswd, String signAlgo, String keyAlgo,
		...
		Select tc=new Select(tconfigure);
		tc.selectByVisibleText(tconf);
		...
		try {
			...
			Thread.sleep(2000);
			((JavascriptExecutor) w).executeScript("arguments[0].scrollIntoView(true);", createUserbtn);
			cl_click(createUserbtn);
			Thread.sleep(20000);
	...
	public void createAdmin(String grp,String cName, String email2, String orgName, String telNo, String city2, String state2,
			String zip, String country2, String role2, String tconf,String tPswd, String signAlgo, String keyAlgo, String vDay,
		...
		cl_entertext(country, country2);
		cl_entertext(tokenPwd, tPswd);
		String[] exptokencon= {"--Select--","ePass","eToken","TrustKey","RSA"};
		Select t=new Select(tconfigure);
		List<WebElement> tconvalue=t.getOptions();
		cl_dropdownCheck(exptokencon,tconvalue);
		t.selectByVisibleText(tconf);
		String[] exp={"--Select--","SHA1WithRSA","SHA256WithRSA","SHA384WithRSA","SHA512WithRSA"};
		Select s1=new Select(signatureAlg);
		List<WebElement> options = s1.getOptions(); 
		cl_dropdownCheck(exp,options);
