...
public class CreateUser_Script extends Basefunctions {
	...
	public void crteUserOfficer(Map hm) throws Exception{	
		...
		String tconf=hm.get("Token_con").toString();
		...
		if(scriptName.equalsIgnoreCase("createOfficer")) {
			...
			err.createUser(cName,email,orgName,telNo,city,state,Zip,country,role,tconf,tPswd,signAlgo,keyAlgo,vDay,vHours,vMin,vSec,IssurTknPswd,aEmail,aPswrd,shtName,scriptName);
		}
	}
