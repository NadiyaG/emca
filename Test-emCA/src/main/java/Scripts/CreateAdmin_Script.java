...
public class CreateAdmin_Script extends Basefunctions {
	...
	public void crteAdmin(Map hm) throws Exception{	
		...
		String tconf=hm.get("Token_conf").toString();
		...
		if(scriptName.equalsIgnoreCase("createAdmin")) {
			...
			err.createAdmin(grp,cName,email,orgName,telNo,city,state,Zip,country,role,tconf,tPswd,signAlgo,keyAlgo,vDay,vHours,vMin,vSec,IssurTknPswd,aEmail,aPswrd,shtName,scriptName);
		}
